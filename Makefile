...
UNREALROOTPATH = /media/Download/Development/UnrealEngine
GAMEPROJECTFILE =/media/Download/Development/ROTR/ROTR.uproject

TARGETS = \
	ROTR-Linux-Debug  \
	ROTR-Linux-DebugGame  \
	ROTR-Linux-Shipping  \
	ROTR-Linux-Test  \
	ROTR \
	ROTREditor-Linux-Debug  \
	ROTREditor-Linux-DebugGame  \
	ROTREditor-Linux-Shipping  \
	ROTREditor-Linux-Test  \
	ROTREditor \
...
ROTR-Linux-Debug:
	 $(PROJECTBUILD) ROTR Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTR-Linux-DebugGame:
	 $(PROJECTBUILD) ROTR Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTR-Linux-Shipping:
	 $(PROJECTBUILD) ROTR Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTR-Linux-Test:
	 $(PROJECTBUILD) ROTR Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTR:
	 $(PROJECTBUILD) ROTR Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTREditor-Linux-Debug:
	 $(PROJECTBUILD) ROTREditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTREditor-Linux-DebugGame:
	 $(PROJECTBUILD) ROTREditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTREditor-Linux-Shipping:
	 $(PROJECTBUILD) ROTREditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTREditor-Linux-Test:
	 $(PROJECTBUILD) ROTREditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ROTREditor:
	 $(PROJECTBUILD) ROTREditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
